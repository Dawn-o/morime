...
export default function AnimeListSkeleton({ showSearch = true, isSearching = false }) {
  return (
    <>
            ...
            {Array.from({ length: 4 }).map((_, sectionIndex) => (
              <div key={sectionIndex} className="border border-primary-foreground p-4 rounded-lg">
                ...
                <div className="flex items-center justify-start flex-wrap gap-2">
                  {Array.from({ length: sectionIndex === 0 ? 18 : sectionIndex === 1 ? 3 : sectionIndex === 2 ? 42 : 5 }).map((_, i) => (
